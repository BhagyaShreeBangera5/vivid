<?php
    ...
    .vivid-loader-bg {
        ...
        width: 100%;
        height: 100%;
        background: radial-gradient(circle, rgba(255,204,0,0.1) 0%, rgba(0,0,0,1) 100%);
    }
    ...
    <div class="modal-overlay" id="feedbackModal">
        <div class="modal-card">
            ...
            <form class="auth-form" method="POST" action="">
                ...
                <select name="rating" required style="width:100%; padding:14px; border-radius:12px; margin-bottom:10px; border:2px solid #f0f0f0;">
                ...
                <textarea rows="4" name="message" placeholder="Your feedback..." required></textarea>
